...
export interface components {
    schemas: {
        ...
        LandingPageRequest: {
            data: {
                whyChooseUs: components["schemas"]["LandingPageWhyChooseUsSectionComponent"];
                locale?: string;
        ...
        WhyChooseUsSectionKeyPointComponent: {
            id?: number;
            title?: string;
            description?: string;
            image?: {
        ...
        LandingPageWhyChooseUsSectionComponent: {
            id?: number;
            title?: string;
            headline?: string;
            description?: string;
            keyPoints?: components["schemas"]["WhyChooseUsSectionKeyPointComponent"][];
        };
        UploadFile: {
            id?: number;
            name?: string;
